...
OUT_BASE = os.path.join(ROOT, "outputs/position-aware-padim-v1/reports/dynamic_ref_card_any_candidate_rd4ad_v1_panel4_clinical_compact")
...
RD4AD_E2_CKPT   = os.path.join(ROOT, "outputs/end/rd4ad_e2_best_model_package_v1/checkpoints/best_train_loss.pth")
RD4AD_E2_EFFB0  = "/home/jinhy/.cache/torch/hub/checkpoints/efficientnet_b0_rwightman-7f5810bc.pth"
RD4AD_E2_HU_MIN, RD4AD_E2_HU_MAX = -1000.0, 600.0
RD4AD_E2_SCORE_DIR = os.path.join(ROOT, "outputs/end/rd4ad_e2_infer_v1")

GRADCAM_CKPT = os.path.join(ROOT,
    "outputs/p_c_normal30b_masked_input_full_train/checkpoints/p_c_normal30b_best_val_auc_checkpoint.pt")
GRADCAM_SCALAR_STATS = os.path.join(ROOT,
    "outputs/reports/p_c_normal24h_fix_zroi_scalar_fusion_drycheck/p_c_normal24h_fix_scalar_normalization_stats.json")
