"""
RD-D1s: Mediastinal 3ch true RD4AD shard-based full run
목적: RD-D1 on-the-fly 대신 pre-built float32 shard를 사용해 빠르게 full train.
...
# 출력
MODEL_ROOT = (
    PROJECT_ROOT / "outputs/models/rd_d1s_true_rd4ad_resnet18_medi3ch_shard_v1"
)
