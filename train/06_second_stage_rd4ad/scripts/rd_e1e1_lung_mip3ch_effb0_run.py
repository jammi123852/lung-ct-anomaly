"""
RD-E1e1: Lung window MIP3ch EfficientNet-B0 RD4AD shard-based full run
목적: 실험 E1 — lung window [-1000,600] + MIP3ch, Teacher=EfficientNet-B0 (features[2/3/4]).
...
SHARD_ROOT        = (
    ...
    / "rd_e1c_lung_mip3ch_train_shards_v1"   # C shard 재사용
)
...
# 출력
MODEL_ROOT = (
    PROJECT_ROOT / "outputs/models/rd_e1e1_effb0_lung_mip3ch_shard_v1"
)
...
def build_teacher():
    """EfficientNet-B0 teacher (features[2]=24ch, features[3]=40ch, features[4]=80ch)"""
    import torch
...
def build_student_decoder():
    """EfficientNet-B0 대응 decoder: late(80ch)→mid(40ch)→early(24ch)"""
...
def run_dry_plan():
    ...
    print(f"  model_type      : true_RD4AD_EfficientNetB0_teacher_student")
...
def run_all_shard():
    ...
    summary = {
        ...
        "model_type":                          "true_RD4AD_EfficientNetB0_teacher_student",
