"""
RD-E1e2: Lung window 3ch EfficientNet-B0 RD4AD shard-based full run
목적: 실험 E2 — lung window [-1000,600] + z-1/z/z+1 단순 스택, Teacher=EfficientNet-B0 (features[2/3/4]).
...
# 출력
MODEL_ROOT = (
    PROJECT_ROOT / "outputs/models/rd_e1e2_effb0_lung3ch_shard_v1"
)
